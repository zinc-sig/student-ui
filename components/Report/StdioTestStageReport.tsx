              ...
              <div className="hidden sm:block">
                <nav className="flex">
                  <button
                    ...
                    className={`px-3 py-2 font-medium text-sm leading-5 rounded-md ${viewingMode==='stdout'?'text-gray-700 bg-gray-100 focus:bg-gray-200':' text-gray-500 hover:text-gray-700 focus:text-gray-700 focus:bg-gray-100'} focus:outline-none`}>
                    Your Output
                  </button>
                  {
